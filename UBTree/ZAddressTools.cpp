...
ZAddressTools::ZAddressTools(std::size_t dimensionByteSize, std::size_t dimensionCount){
	...
	// If Else, because this is constructor and we will use either bsr or fast, not both.
	// Maybe remake so it is more clear
	...
	//Nuly pro pozice bitu, ktereho dimenze se maji vynulovat
	//Pokud chceme vynulovat treba v masce bit na pozici 5, tak maska bude obsahovat 0 na pozici 5 a kazde dalsi pozici stejne dimenze
