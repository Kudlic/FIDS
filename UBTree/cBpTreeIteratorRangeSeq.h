...
template<typename T>
class cBpTreeIteratorRangeSeq : public cBpTreeIterator<T> {
protected:
    ...
    bool init() override;
public:
    cBpTreeIteratorRangeSeq(cNode<T>* root, cTuple<T>* zAddrTupLow, cTuple<T>* zAddrTupHigh, cTreeMetadata* metadata, cZAddrUtils* zTools);
    ~cBpTreeIteratorRangeSeq() override;
...
template<typename T>
cBpTreeIteratorRangeSeq<T>::cBpTreeIteratorRangeSeq(cNode<T>* root, cTuple<T>* zAddrTupLow, cTuple<T>* zAddrTupHigh, cTreeMetadata* metadata, cZAddrUtils* zTools) :
...
template<typename T>
cBpTreeIteratorRangeSeq<T>::~cBpTreeIteratorRangeSeq() {
...
template<typename T>
bool cBpTreeIteratorRangeSeq<T>::init() {
...
template<typename T>
int cBpTreeIteratorRangeSeq<T>::skip(int count) {
    int skipped = 0;
    if (!this->hasNext()) {
        return skipped;
    }
...
template<typename T>
bool cBpTreeIteratorRangeSeq<T>::reset() {
    currentNode = startNode;
    index = startIndex;
    if (currentNode == endNode) {
        currentMaxIndex = endIndex;
